...
function quick_related_post_theme_owlslider()
{
	...
	$html .= '<div class="qrp_wrap_content qrp_custom" >';
	    ...
	    $html .= '<ul id="qrp_owl_carousel" class="qrp_wrap_items owl-carousel owl-theme">';
	        if (has_tag()) {
		        ...
		        if ($tags) {
				        ...
				        $html .= '<li class="qrp_item qrp_item_owl_theme">';
